...
app=tests/bluetooth/bsim_bt/bsim_test_outgoing_num_channels conf_file=prj_1.conf compile
app=tests/bluetooth/bsim_bt/bsim_test_outgoing_num_channels conf_file=prj_5.conf compile
# app=tests/bluetooth/bsim_bt/bsim_test_twice_rejected conf_file=prj_1.conf compile
# app=tests/bluetooth/bsim_bt/bsim_test_twice_rejected conf_file=prj_5.conf compile
