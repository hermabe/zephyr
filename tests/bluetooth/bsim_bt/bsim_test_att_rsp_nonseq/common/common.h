...
#define SHORT_CHRC_SIZE 10
#define LONG_CHRC_SIZE 20
...
extern uint8_t short_chrc_data[SHORT_CHRC_SIZE];
extern uint8_t long_chrc_data[LONG_CHRC_SIZE];

BUILD_ASSERT(sizeof(long_chrc_data) == LONG_CHRC_SIZE, "");
