...
# EATT notification test: A central acting as a GATT client scans for and connects
...
# over EATT, send notifications, disconnect all bearers and recconect EATT_BEARERS_TEST
